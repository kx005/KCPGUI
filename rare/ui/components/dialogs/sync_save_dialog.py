...
class Ui_SyncSaveDialog(object):
    def setupUi(self, SyncSaveDialog):
        ...
        self.cloud_widget_layout = QtWidgets.QHBoxLayout()
        self.cloud_widget_layout.setObjectName("cloud_widget_layout")
        self.verticalLayout.addLayout(self.cloud_widget_layout)
